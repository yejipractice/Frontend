...
import {Mode,Login,Signup, AccountFind, KakaoLogin, NaverLogin} from "../screens";
...
const AuthStack = () => {
    ...
    return (
        ...
        screenOptions={{
            ...
            <Stack.Screen name="NaverLogin" component={NaverLogin} options={{headerBackTitle: false, headerTitle: " "}} />
